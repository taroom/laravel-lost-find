    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div style="text-align:center;" class="section-title">
          ...
          <h2>Barang Temuan</h2>
          <p>Berikut barang-barang yang telah ditemukan pengguna aplikasi</p>
        </div>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="{{ asset('data_file/'.$item->gambar)}}" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>{{$item->judul }}</h4>
              <p>{!! $item->deskripsi !!}</p>
              <a href="{{ asset('data_file/'.$item->gambar)}}" data-gall="portfolioGallery" class="venobox preview-link" title="{{$item->judul}}"><i class="bx bx-plus"></i></a>
              <a href="{{ route('viewbarang', $item->id) }}" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          @endforeach
